...
$db = new mysqli(
    ...
    'root',       // Имя пользователя БД
    '',           // Пароль пользователя (пустой в данном случае)
    'bob_auto_parts'  // Название базы данных
);

// Проверяем успешность подключения
if ($db->connect_error) {
    // Если подключение не удалось, выводим ошибку и завершаем выполнение
